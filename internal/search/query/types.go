...
// execute. The output of executing a plan is the union of individual query results.
type Plan []Q
...
// Pipeline performs query expansion to generate a query plan.
func (parseTree Q) ToPlan() (Plan, error) {
	var err error
	var plan Plan
